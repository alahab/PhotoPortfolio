...
func getData() -> Array<Array<Dictionary<String,String>>> {
    ...
    var data = [
        ...
        [
            "album" : "Norway",
            "title" : "Polar Bear walking on ice",
            "image" : "polar_bear_walking_on_ice",
        ...
        [
            "album" : "Norway",
            "title" : "Seal on ice floe in Svalbard",
            "image" : "seal_on_ice_floe_svalbard",
            "text"  : "You guys, the new How To Draw: drawing and sketching objects and environments from your imagination book by S. Robertson is just amazing! I spent the whole weekend gobbling it up and of course I couldn't help but take the watercolors myself! :)\n\nFill up the gas tank and go check out the attachment!\n\nBehance"
        ]],
    
    [[
    "album" : "Kenya",
    "title" : "Black Rhino grazing",
    "image" : "KENYA_black_rhino_grazing",
    "text"  : "You guys, the new How To Draw: drawing and sketching objects and environments from your imagination book by S. Robertson is just amazing! I spent the whole weekend gobbling it up and of course I couldn't help but take the watercolors myself! :)\n\nFill up the gas tank and go check out the attachment!\n\nBehance"
    ],
    [
    "album" : "Kenya",
    "title" : "Maasai man holding camera ",
